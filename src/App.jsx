...
const tiers = [
  ...
  { name: "Premium", price: "$349", featured: false, features: ["Unlimited county access", "Lawyer consultations (2/mo)", "Skip tracing (unlimited)", "Automated owner outreach", "Court filing assistance", "Heir research tools", "Lead list exports", "Dedicated account manager"] },
]
...
function PricingCard({ t, hoveredTier, setHoveredTier, onGetStarted }) {
      ...
      <div id="pricing" style={{ maxWidth: "1080px", margin: "0 auto", padding: "4rem 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(270px, 1fr))", gap: "1.25rem" }}>
          {tiers.map(function(t) {
            return <PricingCard key={t.name} t={t} hoveredTier={hoveredTier} setHoveredTier={setHoveredTier} onGetStarted={() => openAuth("signup")} />
          })}
        </div>
...
function PricingCard({ t, hoveredTier, setHoveredTier, onGetStarted }) {
  const isHovered = hoveredTier === t.name
  const isActive = hoveredTier === null ? t.featured : isHovered
  const cardBg = isHovered ? "#162a52" : C.card
  const cardBorder = isActive ? C.gold : C.border
  const btnBg = isActive ? C.gold : "transparent"
  const btnColor = isActive ? "#0a1628" : C.light
  const btnBorder = isActive ? "none" : "1px solid " + C.border

  return (
    <div
      onMouseEnter={() => setHoveredTier(t.name)}
      onMouseLeave={() => setHoveredTier(null)}
      style={{ background: cardBg, borderTop: "3px solid " + cardBorder, border: "1px solid " + cardBorder, borderRadius: "4px", padding: "1.75rem", position: "relative", transition: "all 0.2s", cursor: "pointer" }}
    >
      {t.featured && (
        <div style={{ position: "absolute", top: "-11px", left: "50%", transform: "translateX(-50%)", background: C.gold, color: "#0a1628", padding: "0.18rem 0.9rem", fontSize: "0.68rem", fontWeight: "bold", letterSpacing: "0.1em", textTransform: "uppercase", whiteSpace: "nowrap" }}>
          MOST POPULAR
      ...
      <button
        ...
        style={{ width: "100%", padding: "0.8rem", borderRadius: "3px", border: btnBorder, background: btnBg, color: btnColor, fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.07em", fontSize: "0.82rem", textTransform: "uppercase", transition: "all 0.2s" }}
      >
        Get Started
      </button>
    </div>
...
export default function App() {
  ...
  if (page === "dashboard" && user) {
    return (
      <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
        <div style={navStyle}>
          <span style={{ color: C.gold, fontWeight: "bold", letterSpacing: "0.08em", cursor: "pointer", fontSize: "1.1rem" }} onClick={() => setPage("home")}>
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
      <div style={navStyle}>
        <span style={{ color: C.gold, fontWeight: "bold", letterSpacing: "0.08em", fontSize: "1.1rem" }}>SURPLUS RECOVERY PRO</span>
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <button onClick={() => openAuth("login")} style={{ padding: "0.35rem 1rem", border: "1px solid " + C.border, borderRadius: "3px", background: "none", color: C.light, cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}>
            LOG IN
          </button>
          <button onClick={() => openAuth("signup")} style={{ padding: "0.35rem 1rem", border: "none", borderRadius: "3px", background: C.gold, color: "#0a1628", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}>
            GET STARTED
          </button>
        </div>
      </div>
      ...
      <div style={{ textAlign: "center", padding: "5rem 2rem 3.5rem", maxWidth: "860px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <button onClick={() => openAuth("signup")} style={{ padding: "0.8rem 2.2rem", background: C.gold, color: "#0a1628", border: "none", borderRadius: "3px", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.08em", fontSize: "0.9rem" }}>
            START FREE TRIAL
          </button>
          <button onClick={() => document.getElementById("pricing").scrollIntoView({ behavior: "smooth" })} style={{ padding: "0.8rem 2.2rem", background: "transparent", color: C.light, border: "1px solid " + C.border, borderRadius: "3px", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.08em", fontSize: "0.9rem" }}>
            VIEW PRICING
          </button>
        </div>
      </div>
