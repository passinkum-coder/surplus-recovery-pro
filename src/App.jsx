...
const tiers = [
  {
    ...
    price: "$49",
    featured: false,
    features: ["Single county access", "Owner contract templates", "Basic surplus search tools", "Claim status tracking", "Email support"],
  },
  {
    name: "Professional",
    price: "$149",
    featured: true,
    features: ["Multi-county access (up to 5)", "Owner contract templates", "Document filing guides", "Claim status tracking", "Skip tracing (10/mo)", "Priority email support", "County auction alerts"],
  },
  {
    name: "Premium",
    price: "$349",
    featured: false,
    features: ["Unlimited county access", "Lawyer consultations (2/mo)", "Skip tracing (unlimited)", "Automated owner outreach", "Court filing assistance", "Heir research tools", "Lead list exports", "Dedicated account manager"],
  },
]

const addons = [
  { name: "Extra County Access", price: "$19/mo" },
  { name: "Lawyer Consultation", price: "$99/session" },
  { name: "Skip Trace Search", price: "$12/search" },
  { name: "Document Notarization", price: "$29/doc" },
  { name: "Heir Research Report", price: "$79/report" },
  { name: "Done-For-You Filing", price: "$199/claim" },
  { name: "Lead List Export", price: "$49/export" },
  ...
  if (page === "dashboard" && user) {
    return (
      <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
        <div style={navStyle}>
          <span
            style={{ color: C.gold, fontWeight: "bold", letterSpacing: "0.08em", cursor: "pointer", fontSize: "1.1rem" }}
            onClick={() => setPage("home")}
          >
            SURPLUS RECOVERY PRO
          </span>
          <div style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
            <span style={{ color: C.muted, fontSize: "0.82rem", letterSpacing: "0.05em" }}>
              {userName && userName.toUpperCase()} · <span style={{ color: C.gold }}>PROFESSIONAL</span>
            </span>
            <button
              onClick={handleLogout}
              style={{ padding: "0.35rem 0.9rem", border: "1px solid " + C.border, borderRadius: "3px", background: "none", color: C.light, cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.8rem", letterSpacing: "0.05em" }}
            >
              SIGN OUT
            </button>
          </div>
        ...
        <div style={{ padding: "2rem 2.5rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "2rem", flexWrap: "wrap", gap: "1rem" }}>
            <div>
              ...
              <div style={{ color: C.muted, fontSize: "0.8rem", letterSpacing: "0.08em", textTransform: "uppercase" }}>
                Surplus Recovery Dashboard · Professional Plan
              </div>
            </div>
            <button style={{ padding: "0.65rem 1.4rem", background: C.gold, color: "#0a1628", border: "none", borderRadius: "3px", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.06em", fontSize: "0.85rem" }}>
              + NEW CLAIM
            </button>
          </div>
              ...
              <thead>
                <tr style={{ background: "#071020" }}>
                  {["Claim ID", "Owner", "County", "Amount", "Status", "Date"].map(function(h) {
                    return (
                      <th key={h} style={{ padding: "0.7rem 1.25rem", textAlign: "left", fontSize: "0.68rem", color: C.muted, textTransform: "uppercase", letterSpacing: "0.12em", borderBottom: "1px solid " + C.border }}>
                        {h}
                      </th>
                    )
                  })}
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
      <div style={navStyle}>
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <button
            onClick={() => { setMode("login"); setModal("auth"); setAuthError("") }}
            style={{ padding: "0.35rem 1rem", border: "1px solid " + C.border, borderRadius: "3px", background: "none", color: C.light, cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}
          >
            LOG IN
          </button>
          <button
            onClick={() => { setMode("signup"); setModal("auth"); setAuthError("") }}
            style={{ padding: "0.35rem 1rem", border: "none", borderRadius: "3px", background: C.gold, color: "#0a1628", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}
          >
            GET STARTED
          </button>
        </div>
      ...
      <div style={{ textAlign: "center", padding: "5rem 2rem 3.5rem", maxWidth: "860px", margin: "0 auto" }}>
        <div style={{ display: "inline-block", border: "1px solid " + C.gold, color: C.gold, padding: "0.3rem 1.2rem", fontSize: "0.72rem", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1.75rem" }}>
          Surplus Recovery Platform
        </div>
        <h1 style={{ fontSize: "2.8rem", fontWeight: "bold", color: "#fff", lineHeight: 1.2, margin: "0 0 1.25rem" }}>
          Recover Unclaimed Funds<br />
          <span style={{ color: C.gold }}>Faster and Smarter</span>
        </h1>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          <button
            onClick={() => { setMode("signup"); setModal("auth"); setAuthError("") }}
            style={{ padding: "0.8rem 2.2rem", background: C.gold, color: "#0a1628", border: "none", borderRadius: "3px", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.08em", fontSize: "0.9rem" }}
          >
            START FREE TRIAL
          </button>
          <button
            onClick={() => { document.getElementById("pricing").scrollIntoView({ behavior: "smooth" }) }}
            style={{ padding: "0.8rem 2.2rem", background: "transparent", color: C.light, border: "1px solid " + C.border, borderRadius: "3px", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.08em", fontSize: "0.9rem" }}
          >
            VIEW PRICING
          </button>
        </div>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: "3.5rem", padding: "2.25rem 2rem", borderTop: "1px solid " + C.border, borderBottom: "1px solid " + C.border, flexWrap: "wrap" }}>
        {[
          { n: "$2.4M+", l: "Funds Recovered" },
          { n: "1,200+", l: "Claims Filed" },
      ...
      <div id="pricing" style={{ maxWidth: "1080px", margin: "0 auto", padding: "4rem 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(270px, 1fr))", gap: "1.25rem" }}>
          {tiers.map(function(t) {
            return (
              <div key={t.name} onMouseEnter={() => setHoveredTier(t.name)} onMouseLeave={() => setHoveredTier(null)} style={{ background: hoveredTier === t.name ? "#162a52" : C.card, borderTop: "3px solid " + (hoveredTier === t.name ? C.gold : (hoveredTier === null && t.featured ? C.gold : C.border)), border: "1px solid " + (hoveredTier === t.name ? C.gold : (hoveredTier === null && t.featured ? C.gold : C.border)), borderRadius: "4px", padding: "1.75rem", position: "relative", transition: "all 0.2s", cursor: "pointer" }}>
                {t.featured && (
                ...
                <button
                  onClick={() => { setMode("signup"); setModal("auth"); setAuthError("") }}
                  style={{ width: "100%", padding: "0.8rem", borderRadius: "3px", border: "none", background: hoveredTier === t.name ? C.gold : (hoveredTier === null && t.featured ? C.gold : "transparent"), color: hoveredTier === t.name ? "#0a1628" : (hoveredTier === null && t.featured ? "#0a1628" : C.light), fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.07em", fontSize: "0.82rem", textTransform: "uppercase", transition: "all 0.2s", border: (t.featured || hoveredTier === t.name) ? "none" : "1px solid " + C.border }}
                >
                  Get Started
                </button>
              </div>
        ...
        <div style={{ background: C.card, border: "1px solid " + C.border, borderRadius: "4px", padding: "2rem", marginTop: "2rem" }}>
          <div style={{ fontSize: "1.2rem", fontWeight: "bold", color: "#fff", marginBottom: "0.3rem", fontFamily: "Georgia, serif" }}>A La Carte Services</div>
      ...
      {modal === "auth" && (
        <div
          style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.85)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: "1rem" }}
          onClick={() => setModal(null)}
        >
          <div
            style={{ background: C.card, border: "1px solid " + C.border, borderTop: "3px solid " + C.gold, borderRadius: "4px", padding: "2.25rem", width: "100%", maxWidth: "380px", position: "relative" }}
          ...
          >
            ...
            <form onSubmit={handleLogin}>
              ...
              <button
                type="submit"
                disabled={loading}
                style={{ width: "100%", padding: "0.85rem", background: loading ? C.muted : C.gold, color: "#0a1628", border: "none", borderRadius: "3px", fontWeight: "bold", cursor: loading ? "not-allowed" : "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.08em", textTransform: "uppercase" }}
              >
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
      ...
      <div id="pricing" style={{ maxWidth: "1080px", margin: "0 auto", padding: "4rem 2rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(270px, 1fr))", gap: "1.25rem" }}>
          {tiers.map(function(t) {
            return (
              <div key={t.name} onMouseEnter={() => setHoveredTier(t.name)} onMouseLeave={() => setHoveredTier(null)} style={{ background: hoveredTier === t.name ? "#162a52" : C.card, borderTop: "3px solid " + C.gold, border: "1px solid " + (hoveredTier === t.name || t.featured ? C.gold : C.border), borderRadius: "4px", padding: "1.75rem", position: "relative", transition: "all 0.2s", cursor: "pointer" }}>
                {t.featured && (
                  <div style={{ position: "absolute", top: "-11px", left: "50%", transform: "translateX(-50%)", background: C.gold, color: "#0a1628", padding: "0.18rem 0.9rem", fontSize: "0.68rem", fontWeight: "bold", letterSpacing: "0.1em", textTransform: "uppercase", whiteSpace: "nowrap" }}>
                    MOST POPULAR
                  </div>
                ...
                <button
                  onClick={() => { setMode("signup"); setModal("auth"); setAuthError("") }}
                  style={{ width: "100%", padding: "0.8rem", borderRadius: "3px", border: "none", background: (t.featured || hoveredTier === t.name) ? C.gold : "transparent", color: (t.featured || hoveredTier === t.name) ? "#0a1628" : C.light, fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.07em", fontSize: "0.82rem", textTransform: "uppercase", transition: "all 0.2s", border: (t.featured || hoveredTier === t.name) ? "none" : "1px solid " + C.border }}
                >
                  Get Started
                </button>
              </div>
