          ...
          {tiers.map(function(t) {
            return (
              <div key={t.name} style={{ background: C.card, borderTop: "3px solid " + (t.featured ? C.gold : C.border), border: "1px solid " + (t.featured ? C.gold : C.border), borderRadius: "4px", padding: "1.75rem", position: "relative" }}>
                ...
                <button
                  onClick={() => { setMode("signup"); setModal("auth"); setAuthError("") }}
                  style={{ width: "100%", padding: "0.8rem", borderRadius: "3px", border: t.featured ? "none" : "1px solid " + C.border, background: t.featured ? C.gold : "transparent", color: t.featured ? "#0a1628" : C.light, fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", letterSpacing: "0.07em", fontSize: "0.82rem", textTransform: "uppercase" }}
                >
                  Get Started
                </button>
              </div>
    ...
    return (
      <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
        <div style={navStyle}>
          ...
          <div style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
            <span style={{ color: C.muted, fontSize: "0.82rem", letterSpacing: "0.05em" }}>
              {user && user.name.toUpperCase()} · <span style={{ color: C.gold }}>PROFESSIONAL</span>
            </span>
            <button
        ...
        <div style={{ padding: "2rem 2.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(190px, 1fr))", gap: "1.25rem", marginBottom: "2rem" }}>
            {[
              { l: "Active Claims", v: "4", s: "+2 this month", c: C.gold },
              { l: "Total Recovered", v: "$58,250", s: "↑ 18% vs last month", c: C.green },
              { l: "Counties Tracked", v: "3", s: "5 max on your plan", c: C.purple },
              { l: "Pending Actions", v: "2", s: "Requires attention", c: C.red },
            ].map(function(x) {
              return (
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "Georgia, serif" }}>
      <div style={navStyle}>
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <button
            onClick={() => { setMode("login"); setModal("auth") }}
            style={{ padding: "0.35rem 1rem", border: "1px solid " + C.border, borderRadius: "3px", background: "none", color: C.light, cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}
          >
            LOG IN
          </button>
          <button
            onClick={() => { setMode("signup"); setModal("auth") }}
            style={{ padding: "0.35rem 1rem", border: "none", borderRadius: "3px", background: C.gold, color: "#0a1628", fontWeight: "bold", cursor: "pointer", fontFamily: "Georgia, serif", fontSize: "0.82rem", letterSpacing: "0.05em" }}
          >
            GET STARTED
          </button>
      ...
      {modal === "auth" && (
        ...
        >
          ...
          >
            ...
            <div style={{ textAlign: "center", marginTop: "1.25rem", fontSize: "0.83rem", color: C.muted }}>
              {mode === "login" ? "Don't have an account? " : "Already have an account? "}
              <span style={{ color: C.gold, cursor: "pointer" }} onClick={() => setMode(mode === "login" ? "signup" : "login")}>
                {mode === "login" ? "Sign up free" : "Sign in"}
              </span>
            </div>
          </div>
